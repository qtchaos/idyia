...
const companies = [
  {
    ...
    companyType: "saas",
    description:
      "Uses generative AI for automated driver/rider support chat, reducing human agent load by ~40%.",
    companySize: "G",
    imageUrl: null,
  ...
  },
  {
    ...
    description:
      "AI-generated seasonal promotional posters and social media content used across Estonian locations.",
    companySize: "D",
    imageUrl: null,
  ...
  },
  {
    ...
    companyType: "saas",
    description:
      "AI-generated email drafts and deal summaries inside the CRM. Powered by OpenAI GPT-4.",
    companySize: "F",
    imageUrl: null,
  ...
  },
  {
    ...
    companyType: "retail",
    description:
      "Product description copy for online store generated using GPT-4o; internal QA chatbot deployed.",
    companySize: "E",
    imageUrl: null,
  ...
  },
  {
    ...
    companyType: "saas",
    description:
      "Generative AI used to synthesise edge-case training data for identity fraud detection models.",
    companySize: "E",
    imageUrl: null,
  ...
  },
  {
    ...
    description:
      "Auto-generated course summaries and exam feedback for students via an internal LLM deployment.",
    companySize: "D",
    imageUrl: null,
  ...
  },
  {
    ...
    companyType: "finance",
    description:
      "Customer-facing loan offer summaries and internal compliance document drafting use GPT-4.",
    companySize: "E",
    imageUrl: null,
  ...
  },
  {
    ...
    companyType: "finance",
    description:
      "In-app AI assistant handles FX explanations and fee breakdowns for 16M+ customers.",
    companySize: "H",
    imageUrl: null,
  ...
  },
  {
    ...
    companyType: "saas",
    description:
      "Engineering RFP documents auto-drafted using internal GPT-4 fine-tune trained on product specs.",
    companySize: "C",
    imageUrl: null,
